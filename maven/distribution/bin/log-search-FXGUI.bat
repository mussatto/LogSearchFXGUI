...
@rem ##########################################################################
@rem
@rem  log-search-FXGUI startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute log-search-FXGUI
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_OPTS%  -classpath "%CLASSPATH%" com.curupira.Launcher %CMD_LINE_ARGS%
